<form id='create' action="" enctype="multipart/form-data" autocomplete="off" method="post" accept-charset="utf-8"
    ...
    <div class="col-12 col-md-6 my-1">
        ...
        <input id="student_id" class="form-control" type="text" name="student_id" placeholder="Enter student id"
            required>
        <span id="error_student_id" class="text-danger error"></span>
    </div>
    ...
    <div class="col-12 col-md-6 my-1">
        ...
        <input id="mobile" class="form-control" type="text" name="mobile" placeholder="Enter mobile no" required>
